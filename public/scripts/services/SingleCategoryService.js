...
//     .factory('SingleCategory', function ($q) {
//
//         var Category = Parse.Object.extend('SingleCategory', {}, {
//
...
//
// //--------------add Relation----------
//                 if (category.places && category.places !== null) {
//                     var relation = objCategory.relation('placesAll');
//
//                     relation.add(category.places[0]);
//                     delete category.places;
//                 }
// //-----------------------------------
//
...
//         });
//
//         Object.defineProperty(Category.prototype, 'placesAll',
//             {
//                 get: function () {
//                     return this.get('placesAll');
//                 },
//                 set: function (val) {
//                     this.set('placesAll', val);
//                 }
//             });
